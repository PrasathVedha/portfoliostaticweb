...
// Update repo links with the specified ones
const projects = [
  {
    id: 1,
    title: 'AWS Storage',
    ...
    image: <AnimatedCloud />,
    repoLink: 'https://github.com/PrasathVedha/CloudStorage',
  },
  {
    id: 2,
    title: 'Sudoku Solver',
    ...
    repoLink: 'https://github.com/PrasathVedha/Sudoku-Solver',
  },
  {
    id: 3,
    ...
    repoLink: 'https://github.com/PrasathVedha/SportClub-Website',
  },
];
  ...
  >
    ...
    <div className="p-6">
      ...
      <div className="flex space-x-3">
        ...
        >
          <a href={project.repoLink} target="_blank" rel="noopener noreferrer" aria-label="View GitHub Repository" className="flex items-center">
      ...
      <div className="section-container">
        ...
        >
          ...
          <Button asChild className="bg-primary hover:bg-primary/90">
            <a
              href="https://github.com/PrasathVedha?tab=repositories"
              target="_blank"
