          ...
          delay: 0.2
            ...
            <div className="data-card">
              ...
              <div className="flex space-x-4 mb-6">
                ...
                <a href="https://github.com/PrasathVedha" target="_blank" rel="noopener noreferrer" className="h-12 w-12 rounded-full bg-gray-800/10 flex items-center justify-center hover:bg-gray-800/20 transition-colors">
