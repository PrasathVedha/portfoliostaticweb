          ...
          delay: 0.2
            ...
            <div className="data-card">
              ...
              <div className="flex space-x-4 mb-6">
                <a href="https://www.linkedin.com/in/prasath-vedharethinam/" target="_blank" rel="noopener noreferrer" className="h-12 w-12 rounded-full bg-[#0077B5]/10 flex items-center justify-center hover:bg-[#0077B5]/20 transition-colors">
                ...
                <a href="https://github.com/PrasathVedha?tab=repositories" target="_blank" rel="noopener noreferrer" className="h-12 w-12 rounded-full bg-gray-800/10 flex items-center justify-center hover:bg-gray-800/20 transition-colors">
                ...
                <a href="mailto:prasath.vedha@gmail.com" className="h-12 w-12 rounded-full bg-red-500/10 flex items-center justify-center hover:bg-red-500/20 transition-colors">
